...
// JumpRule describes one option-controlled jump in provider question numbering.
...
// DisplayCondition describes when a question is visible.
...
// DisplayControl describes a question whose answer controls another question.
...
// QuestionLogic contains normalized jump and conditional-display metadata.
...
// QuestionMedia describes media attached to a question or option.
...
// AttachedOptionSelect describes a secondary select attached to an option.
...
// SliderRange contains provider slider bounds and step size.
...
// QuestionMeta is the public provider-neutral metadata for one question.
