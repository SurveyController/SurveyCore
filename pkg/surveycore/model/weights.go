...
// Values returns a copy of option weights.
func (w WeightTable) Values() []float64 {
	return append([]float64(nil), w.Options...)
}

// Row returns a copy of one matrix row, or nil when row is out of range.
