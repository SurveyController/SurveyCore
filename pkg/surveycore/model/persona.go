...
// Persona describes the generated respondent identity passed to AI callbacks.
type Persona struct {
	Gender               string
	AgeGroup             string
	Education            string
...
// KeywordMap returns normalized keywords used to align categorical answers.
...
// Description returns a compact human-readable persona description.
